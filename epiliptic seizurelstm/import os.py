...
def pre():
    ...
    result=''
    if prediction[0] == 1:
        result="Epileptic Seizure Not Detected From EEG Signals"
    if prediction[0] == 2:
        result="Epileptic Seizure Frist Stage Detected From EEG Signals"
    if prediction[0] == 3:
        result="Epileptic Seizure Second Stage Detected From EEG Signals"
    if prediction[0] == 4:
        result="Epileptic Seizure Third Stage Detected From EEG Signals"
    if prediction[0] == 5:
        result="Epileptic Seizure Fourth Stage Detected From EEG Signals"
